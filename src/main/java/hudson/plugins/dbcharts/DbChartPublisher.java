...
import hudson.plugins.dbcharts.SqliteJDBCConnection.SqliteJDBCConnectionDescriptor;
...
public class DbChartPublisher extends Recorder {
    ...
    public DescriptorImpl getDescriptor() {
        ...
        DescriptorImpl di = (DescriptorImpl) super.getDescriptor();
        logger.info("DbChartPublisher.getDescriptor():"+di.getDisplayName());
        return di;
    }
    ...
    public static final class DescriptorImpl extends BuildStepDescriptor<Publisher> {
        ...
        public List<Descriptor> getJDBCConnectionDescriptors() {
            ...
            Descriptor<?> sqlite = Hudson.getInstance().getDescriptorByType(SqliteJDBCConnectionDescriptor.class);
            res.add(sqlite);
            res.add(mysql);
            res.add(pgsql);
            res.add(custom);
            logger.fine("getJDBCConnectionDescriptors(): custom=" + custom + "; mysql=" + mysql +"; sqlite="+sqlite);
            return res;
        }
    }
}
